...
public class TransactionsFlowtypeYearCount {
    ...
    public static class MapForFlowYear extends Mapper<LongWritable, Text, TransactionsFlowtypeYearWritable, IntWritable> {
           /* Recebe valor e transforma para string, separa os valores por ";" utilizando split colocando-os em
            ...
            os years e os flows, cria chaves compostas (yearFlow) e seus respectivos contadores (n) */
